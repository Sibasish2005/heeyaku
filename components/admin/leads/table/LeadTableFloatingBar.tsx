...
export default function LeadTableFloatingBar({
  ...
  return (
    <div className="sticky top-16 z-30 bg-[#0B1F33] text-white px-5 py-3 rounded-2xl shadow-xl border border-slate-700 flex flex-wrap items-center justify-between gap-3 animate-in slide-in-from-top-3 duration-200">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-500 rounded-xl transition-colors shadow-2xs"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-amber-300 hover:text-amber-200 bg-amber-950/40 hover:bg-amber-950/60 border border-amber-800/60 rounded-xl transition-colors disabled:opacity-50"
        >
        ...
        <div className="relative group">
          <button
            type="button"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold text-slate-300 hover:text-white bg-slate-800 hover:bg-slate-700 border border-slate-700 rounded-xl transition-colors"
          >
