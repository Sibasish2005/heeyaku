...
import { Search, Plus, Upload, Download, Filter, RotateCcw, X } from 'lucide-react';
...
export default function LeadTableToolbar({
  ...
  return (
    <div className="bg-card text-card-foreground p-3.5 sm:p-4 rounded-2xl border border-border shadow-2xs space-y-3">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-8 pr-8 py-2 text-xs bg-muted/40 focus:bg-background border border-border focus:border-[#2563EB] text-foreground rounded-xl outline-hidden transition-colors placeholder:text-muted-foreground font-medium"
          />
          {searchQuery && (
            <button
              type="button"
        ...
        <div className="flex items-center gap-2 justify-end">
          <div className="relative group">
            <button
              type="button"
              className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-bold text-foreground bg-card hover:bg-muted/60 border border-border rounded-xl transition-colors shadow-2xs cursor-pointer"
            >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 text-xs font-bold text-white bg-[#2563EB] hover:bg-blue-500 rounded-xl transition-colors shadow-2xs cursor-pointer"
          >
      ...
      {/* Tier 2: Dedicated Filter Controls & Live Count */}
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {hasActiveFilters && onResetFilters && (
            <button
              ...
              className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-semibold text-muted-foreground hover:text-foreground hover:bg-muted/60 rounded-xl border border-transparent hover:border-border transition-colors cursor-pointer"
