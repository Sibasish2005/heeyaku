...
export default function EditLeadFormFields({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div className="space-y-1">
        <label className="text-xs font-bold text-foreground">Source</label>
        <input
          type="text"
      ...
      <div className="space-y-1 sm:col-span-2">
        ...
        <textarea
          ...
          className="w-full px-3 py-2 text-xs bg-muted/40 focus:bg-background border border-border focus:border-[#2563EB] text-foreground rounded-xl outline-hidden transition-colors resize-none"
        />
      </div>
    </div>
  );
