      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-500 hover:text-[#0B1F33] transition-colors duration-150 active:scale-[0.97]"
          >
            <GithubIcon className="w-4 h-4 text-[#0B1F33]" />
            <span>Star Us</span>
          </Link>
          ...
          >
            ...
            <div className="pt-4 border-t border-slate-200 flex flex-col gap-3">
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-2.5 text-sm font-semibold text-[#0B1F33] bg-slate-100 hover:bg-slate-200 rounded-xl active:scale-[0.98] transition-colors duration-150"
              >
                <GithubIcon className="w-4 h-4 text-[#0B1F33]" />
