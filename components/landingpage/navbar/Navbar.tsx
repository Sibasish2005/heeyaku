                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <SignInButton mode="modal">
                      <button
                        type="button"
                        onClick={() => setMobileMenuOpen(false)}
                        className="w-full flex items-center justify-center py-2.5 text-xs font-bold uppercase tracking-wider text-[#0B1F33] border border-slate-200 rounded-full hover:bg-slate-50 active:scale-[0.97] transition-transform duration-150 cursor-pointer"
                      >
                        Sign In
                      </button>
                    </SignInButton>
